...
int main(int argc, char *argv[])
{
	...
	for (trial = 0; trial < ntrials / p; trial++) /* Χωρίζουμε τον αριθμό των trials σε κάθε process, αν δεν το κάναμε κάθε process Θα έκανε ntrials! */
	{
		...
		if (fx < best_fx)
		{
			...
			for (i = 0; i < nvars; i++)
				best_pt[i] = endpt[i];
		} /*Κάθε process υπολογίζει τις καλύτερες τιμές του για να μειώσουμε τον αριθμό των μηνυμάτων που θα στέλνονται και να αποφύγουμε το πάγωμα του προγράμματος */
	}
	...
	else
	{
		...
		printf("Total number of function evaluations = %ld\n", funevals * p); /* Παρόμοια με το OpenMP πολλαπλασιάζουμε τον αριθμό των πράξεων με τον αριθμό των processes για να βρούμε τον πραγματικό αριθμό των πράξεων */
